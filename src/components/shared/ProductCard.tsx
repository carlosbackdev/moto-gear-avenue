        ...
        <Card className="group overflow-hidden border-border hover:shadow-hover transition-all duration-300">
          ...
          <CardFooter className="flex flex-col items-start p-4 space-y-2">
            <div className="w-full">
              <p className="text-[10px] text-muted-foreground/60 tracking-wide">{product.brand}</p>
              <h3 className="font-bold text-sm line-clamp-2 uppercase group-hover:text-primary transition-colors">
                {product.name}
              </h3>
            </div>
